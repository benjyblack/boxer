...
void openSound()
{
  ...
  ahhh = minim.loadSample("ahhh.mp3", 1024);
  punchSound = minim.loadSample("punch.wav", 1024);
  doorSound = minim.loadSample("door-open-7.wav",1024);
  deathSound = minim.loadSample("grunt.wav",1024);
  biteSound = minim.loadSample("bite.wav", 1024);
  knifeSound = minim.loadSample("slash.wav", 1024);
  stompSound  = minim.loadSample("stomp.wav", 1024);
  bellSound = minim.loadSample("bell.wav", 1024);
  gameOverSound = minim.loadFile("gameover.mp3", 4096);
  sludgeSound = minim.loadSample("sludge.wav", 2048);
  laserSound = minim.loadSample("beam.wav", 4000);
  oilSound = minim.loadSample("oil.wav", 1024);
  explodeSound = minim.loadSample("explosion.wav", 1024);
  powerAcqSound = minim.loadSample("poweracq.wav", 1024);
  bgm = minim.loadFile("DuHast.mp3", 4096);
}
void closeSound()
{
  ahhh.close();
  ...
  void stepPhysics()
  {
    ...
    Iterator it = sprites.iterator();
    {
      ...
      while(it.hasNext())
      {
        ...
        else if(c.hostile) hasHostiles = true;
      }
      if(!hasHostiles) cleared = true;
    }
...
void setup()
{
  ...
  bckgrnd1 = loadImage("levelTemplateDoorClosed.png");
  bckgrnd2 = loadImage("levelTemplateDoorOpen.png");
  //INSERT TRAP IMAGES HERE
  spikesLeft = loadImage("spikesLeft.png");
  spikesRight = loadImage("spikesRight.png");
  spikesUp = loadImage("spikesUp.png");
  spikesDown = loadImage("spikesDown.png");
  tnt = loadImage("tnt.png");
  tntexplode = loadImage("explosion.png");
  trigger = loadImage("trigger.png");
  triggerclosed = loadImage("triggerclosed.png");
  sludge = loadImage("sludge.png");
  teeth = loadImage("teeth.png");
  teethUsed = loadImage("teethUsed.png");
  oil = loadImage("oil.png");
  plate = loadImage("plate.png");
  turret = loadImage("turret.png");
  //INSERT HERO IMAGE HERE
  hero = new Animation("Boxer2(", 15);
  beam = new Animation("beam(", 7);
  decoy = loadImage("decoy.png");
  decoyZombie = loadImage("decoyZombie.png");
  //INSERT ENEMY IMAGES HERE
  boss = loadImage("boss.png");
  enemy = loadImage("suit.png");
  enemyDrugged = loadImage("suitZombie.png");
  toughEnemy = loadImage("ToughGuy.png");
  toughEnemyDrugged = loadImage("ToughGuyZombie.png");
  fastEnemy = loadImage("ninja.png");
  ninjaDrugged=  loadImage("ninjaZombie.png");
  boss = loadImage("boss.png");
  //INSERT ATTACK IMAGES HERE
  punch = loadImage("glove.png");
  powerPunch = loadImage("powerPunch.png");
  //INSERT MISCELLEANOUS IMAGES HERE
  textC = loadImage("textC.png");
  textV = loadImage("textV.png");
  textB = loadImage("textB.png");
  textD = loadImage("textD.png");
  volume = loadImage("volume.png");
  volumeOff = loadImage("volumeOff.png");
  powers = loadImage("powers.png");
